...
const Preview = () => {
  ...
  const completeFooter = `<div class="bg-info mt-24">
  ...
  <div>
    ...
    <p class="mt-2">ACME Industries Ltd.<br/>Providing reliable tech since 1992</p>
  </div> 
  <div>
    <span class="text-2xl font-bold text-white/90 mb-2">Services</span> 
  ...
  <div>
    <span class="text-2xl font-bold text-white/90 mb-2">Company</span> 
  ...
  <div>
    <span class="text-2xl font-bold text-white/90 mb-2">Legal</span> 
